...
public class HttpRequest {
	...
	/**
     * GET to a specified url
     * 
     * @param url
     *            the URL of the specified address
     * @param param
     *            parameters used in the request, 
     *            the format should be like name1=value1&name2=value2
     * @return The String responsed by server.
     */
